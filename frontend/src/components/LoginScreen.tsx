          ...
          <div className="relative bg-black/80 backdrop-blur-3xl border-2 border-white/10 rounded-3xl p-8 sm:p-12 shadow-[0_0_80px_rgba(139,127,255,0.15)] overflow-hidden">
            ...
            <div className="relative mb-8">
              <motion.button
                ...
                className="group relative w-full flex items-center justify-center gap-3 sm:gap-4 bg-white hover:bg-gray-100 text-black font-black text-base sm:text-xl py-4 sm:py-6 px-5 sm:px-6 rounded-2xl transition-all shadow-[0_10px_40px_rgba(255,255,255,0.2)] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer overflow-hidden"
              >
                ...
                {isLoading ? (
                  <>
                    <Loader2 className="w-5 h-5 sm:w-7 sm:h-7 animate-spin text-gray-500" />
                    <span>INITIALIZING 0G...</span>
                  </>
                ) : (
                  <>
                    {/* Minimalist bold Google logo */}
                    <svg className="w-5 h-5 sm:w-7 sm:h-7 flex-shrink-0" viewBox="0 0 24 24" aria-hidden="true">
