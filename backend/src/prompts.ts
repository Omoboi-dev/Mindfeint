...
export const PACKS: PromptPack[] = [
  {
    ...
    prompts: [
      ...
      "What's a popular opinion you secretly think is completely wrong?",
      "What's a tiny act that quietly makes someone a bad person?",
      "What's the most pointless subscription people happily pay for?",
      "What rule do you break on purpose every single day?",
      "What's a compliment that is actually kind of an insult?",
      "What trend do you refuse to take part in, no matter what?",
      "What's something cheap that is honestly better than the expensive version?",
      "What's a chore everyone exaggerates how hard it is?",
      "What is socially accepted but should honestly be illegal?",
      "What's the pettiest reason you have stopped talking to someone?",
    ],
  },
  {
    id: "confess",
    ...
    prompts: [
      ...
      "What's a habit you pretend to have but absolutely do not?",
      "What's something everyone assumes you love but you secretly hate?",
      "What's a small win you are way too proud of?",
      "What's the laziest thing you have done to avoid a tiny task?",
      "What's a fear you have that you know is irrational?",
      "What do you pretend to understand but really do not?",
      "What's the pettiest grudge you are still holding right now?",
      "What's something you would do if you knew nobody would judge you?",
      "What's a white lie you tell almost every week?",
      "What's a guilty pleasure you would never admit out loud?",
    ],
  },
  {
    id: "intellectual",
    ...
    prompts: [
      ...
      "Is it better to be honest and hurt someone, or kind and lie?",
      "Would you want to know the exact day you will die?",
      "If memories could be sold, would you ever sell one?",
      "Does a person stay the same person their whole life?",
      "Is being forgotten worse than never having existed?",
      "If everyone could read minds, would society survive?",
      "What's something everyone believes that might be a comforting illusion?",
      "Would immortality be a gift or a punishment?",
      "Is happiness a choice, or mostly luck?",
    ],
  },
  {
    id: "casual",
    ...
    prompts: [
      ...
      "What's the best meal you have ever had that cost almost nothing?",
      "What song instantly puts you in a good mood, no matter what?",
      "What's a small thing that made your week recently?",
      "If you had a free hour right now, how would you actually spend it?",
      "What's a hobby you would pick up if money and time were no issue?",
      "What's the most useless fact living rent free in your head?",
      "What's your go-to order that you never change?",
      "What show could you rewatch ten times and never get tired of?",
      "What's a small luxury that feels worth every penny to you?",
    ],
  },
  {
    id: "scifi",
    ...
    prompts: [
      ...
      "You can teleport anywhere instantly, but it hurts a little every time. Worth it?",
      "What's the first law you would pass as ruler of a Mars colony?",
      "If you could upload one skill directly into your brain, what would it be?",
      "Robots can now have feelings. What's the first job they should never do?",
      "You get one message to send to the year 3000. What does it say?",
      "If you could keep one piece of today's tech forever, what would it be?",
      "Aliens want one human food as a gift. What do you send?",
      "What's a present-day problem that future people will find absurd?",
      "If your dreams were recorded and posted publicly, how worried are you?",
    ],
  },
];
